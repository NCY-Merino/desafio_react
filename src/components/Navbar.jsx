        ...
        <nav className="navbar navbar-expand-lg bg-dark border-bottom border-body" data-bs-theme="dark">
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <Link className="btn btn-outline-light btn-sm me-md-2" onClick={handleLogin}>{!token ? '🔐 Login' : '🔓 Logout' }</Link>
                    <Link className="btn btn-outline-light btn-sm me-md-2" onClick={handleLogin}>{!token ? '🔐 Register' : '🔒 Profile'}</Link>
                </div>
